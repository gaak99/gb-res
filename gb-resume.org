...
**** bash(1)
***** /Oxmerge/ is a shell wrapper for /Oxly/ for the common case [[https://github.com/gaak99/oxly/blob/master/oxly/scripts/oxmerge.sh][github]]
**** Emacs Lisp
...
The svc was based on Openstack Swift[fn:2] object storage code (Python).  It ran on a Ubuntu server cluster.
...
#+END_QUOTE
[fn:2] [[https://wiki.openstack.org/wiki/Swift][Openstack Wiki]]
#+BEGIN_QUOTE
