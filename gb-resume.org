...
* [[https://gaak99.github.io/resume][URL]] of this Resume
Other formats including plain text are [[https://github.com/gaak99/gb-res][here]].
* Contact
...
basis. Also good use of Python object oriented features and decorators
(I wrote /_dbxauth/ in core.py, and the /Click/ library API used here
is heavily based on them).
...
****** Agile methodology and JIRA/Confluence was used for all the projects
...
***** Kerberos KDC server db replication
I led team and co-designed/developed (C language) RPC-based DB
replication protocol/feature for the Kerberos KDC. This code was
fed upstream and subsequently released by MIT Kerberos Open
Source Project.
***** Solaris kernel RPC GSS modules server performance improvements
***** Solaris single sign-on via GSS/Kerberos
